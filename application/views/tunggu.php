        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Form Pelayanan</h2>
                </div>
                <div class="card-body">
                    <h1>Silahkan tunggu teknisi kami segera ketempat anda</h1>              
                        <div>
                            <button class="btn btn--radius-2 btn--red"><a href="<?php echo base_url(); ?>home">Submit</a></button>
                        </div>
                </div>
            </div>
        </div>
